...
public abstract class AbstractObservableCachedDatastore<T extends Cacheble> implements ObservableDatastore<T>,Observer<T> {
    ...
    protected abstract Observable<Boolean> insertOnStorage(T model) throws Exception;

    protected abstract Observable<Boolean> updateOnStorage(T model) throws Exception;

    protected abstract Observable<Boolean> deleteOnStorage(T model) throws Exception;

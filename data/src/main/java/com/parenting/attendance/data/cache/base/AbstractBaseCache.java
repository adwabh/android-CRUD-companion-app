...
import com.parenting.attendance.data.cache.FileManager;
...
public abstract class AbstractBaseCache<T extends AbstractCachedDatastore> implements BaseCache {
...
//    private static final String SETTINGS_FILE_NAME = "io.app.eatrepeat_preferences_skipuser";
    ...
    private static AbstractBaseCache ourInstance;
    @Inject
...
//    private LruCache<Long, Cacheble> memCache;
    ...
    public AbstractBaseCache(Context context, T databaseDatastore, String lastCacheUpdate) {

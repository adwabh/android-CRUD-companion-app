 ...
 */
package com.parenting.attendance.test.view.activity;
...
public class UserDetailsActivityTest extends ActivityInstrumentationTestCase2<UserDetailsActivity> {
  ...
  public void testLoadUserHappyCaseViews() {
    ...
    onView(ViewMatchers.withId(R.id.tv_email)).check(matches(isDisplayed()));
    onView(ViewMatchers.withId(R.id.tv_description)).check(matches(isDisplayed()));
  }

  public void testLoadUserHappyCaseData() {
    onView(ViewMatchers.withId(R.id.tv_fullname)).check(matches(withText("John Sanchez")));
    onView(ViewMatchers.withId(R.id.tv_email)).check(matches(withText("dmedina@katz.edu")));
    onView(ViewMatchers.withId(R.id.tv_followers)).check(matches(withText("4523")));
  }
